...
---
//[ScienerCardEncoder SDK](../../../index.html)/[com.ttlock.cardencoder](../index.html)/[ScienerCardEncoderImpl](index.html)/[setServerBaseUrl](set-server-base-url.html)
...
[androidJvm]\
open override fun [setServerBaseUrl](set-server-base-url.html)(baseUrl: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-string/index.html))
...
| | |
|---|---|
| [ScienerCardEncoderImpl.getServerBaseUrl](get-server-base-url.html) | 获取当前服务器URL方法 |
