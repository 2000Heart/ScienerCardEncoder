//[ScienerCardEncoder SDK](../../../index.md)/[com.ttlock.cardencoder](../index.md)/[ScienerCardEncoderImpl](index.md)/[setSectorConfig](set-sector-config.md)
...
| | |
|---|---|
| [ScienerCardEncoderImpl.getSectorConfig](get-sector-config.md) | 获取扇区配置方法 |
