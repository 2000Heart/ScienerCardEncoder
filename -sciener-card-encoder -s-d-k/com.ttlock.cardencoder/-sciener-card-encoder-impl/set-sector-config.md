...
---
//[ScienerCardEncoder SDK](../../../index.html)/[com.ttlock.cardencoder](../index.html)/[ScienerCardEncoderImpl](index.html)/[setSectorConfig](set-sector-config.html)
...
| | |
|---|---|
| [ScienerCardEncoderImpl.getSectorConfig](get-sector-config.html) | 获取扇区配置方法 |
