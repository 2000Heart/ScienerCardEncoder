...
---
//[ScienerCardEncoder SDK](../../../index.html)/[com.ttlock.cardencoder](../index.html)/[ScienerCardEncoderImpl](index.html)/[getNetworkTimeout](get-network-timeout.html)
...
[androidJvm]\
open override fun [getNetworkTimeout](get-network-timeout.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-int/index.html)
...
| | |
|---|---|
| [ScienerCardEncoderImpl.setNetworkTimeout](set-network-timeout.html) | 设置网络超时时间方法 |
